...
export default class Entity {
    ...
    static entities = [
        ...
        },
        {
            ...
            provide(elem) {
                ...
                elem.style.backgroundImage = `url("./images/asteroids/${index}.png")`;
                elem.destroy = _ => {
        ...
        },
        {
            ...
            provide(elem) {
                ...
                elem.style.backgroundImage = `url("./images/enemy${index}.gif")`;
            },
            collidedFn(target, elem) {
                if (isPlayer(target)) {
                    Game.state.fuel -= 15;
        ...
        },
        {
            ...
            provide(elem) {
                ...
                elem.style.backgroundImage = `url("./images/planets/big${rnd(0, 5)}.png")`;
            }
        },
        {
            ...
            provide(elem) {
                ...
                elem.style.backgroundImage = `url("./images/planets/small${rnd(0, 5)}.png")`;
            }
        }
    ];
    ...
    static createBullet(deps) {
        ...
        elem.destroy = (direction = [-40, -90]) => {
            elem.colors = ["#dcdddd", "#e5371e", "#ed7766", "#5fb6df", "#008acc", "#f2a755"];
